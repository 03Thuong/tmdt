...
// make the background colour selector
    ...
    $colour_list = array('none' => JText::_('JNONE'), 'white' => JText::_('COM_FLEXICONTACT_WHITE'), 'black' => JText::_('COM_FLEXICONTACT_BLACK'), 'gray' => JText::_('COM_FLEXICONTACT_GREY'));
...
// filter header
	...
	foreach ($imageFiles as $filename)
		...
		echo JHTML::_('grid.id',   $i++, $filename);
