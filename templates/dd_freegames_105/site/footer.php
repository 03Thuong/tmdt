...
.bd-section-4 {
    padding-top: 1em;
    padding-bottom: 0;
    background-image: url(<?php echo JURI::base()?>/<?php echo $document->params->get('bgf'); ?>);
...
<?php echo $document->params->get('fo0'); ?>
</h1>
...
<?php echo $document->params->get('fo1'); ?>
</h3>
	
		<p class=" bd-textblock-94 bd-content-element">
<?php echo $document->params->get('fo2'); ?>
</p></div></div>
</div>
...
<?php echo $document->params->get('fo3'); ?>
</h3>
...
<?php echo $document->params->get('fo4'); ?><br><?php echo $document->params->get('fo5'); ?>
...
<?php echo $document->params->get('fo6'); ?><br>
<?php echo $document->params->get('fo7'); ?>
</p>
    </div>
</div>
...
<a href="mailto:<?php echo $document->params->get('fo8'); ?>" draggable="false">
    
<?php echo $document->params->get('fo8'); ?></a>

<br><a href="mailto:<?php echo $document->params->get('fo9'); ?>" draggable="false">
<?php echo $document->params->get('fo9'); ?>
</a>
