...
$megamenuClass = '';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-40';
...
ob_start();
?>
<div class="bd-menu-15 bd-no-margins bd-mega-grid bd-grid-10">
...
ob_start();
?>
<div class="bd-menuitem-37 bd-sub-item bd-mega-item  bd-menuitem-38 separated-item-11">
...
ob_start();
?>
<li class=" bd-menuitem-34 bd-toplevel-item {submenu_icon_only}">
<?php 
