<?php
function joomlaposition_block_39($caption, $content, $classes = '', $id = '', $extraClass = '')
{
    ...
    ob_start();
    ?>
    <div class=" bd-block-29 bd-own-margins <?php echo $classes; ?>" <?php echo $id; ?>>
    <?php if ($hasCaption) : ?>
...
<?php endif; ?>
    ...
    <div class="bd-blockcontent bd-tagstyles bd-bootstrap-btn bd-btn-default<?php echo $extraClass;?>">
